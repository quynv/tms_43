...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/usercourse-join/$', views.UserCourseJoin.as_view(), name='usercourse-join'),
    ...
    url(r'^(?P<course_id>[0-9]+)/subjects/(?P<pk>[0-9]+)/usersubject-change-status/$',
        views.UserSubjectChangeStatus.as_view(), name='usersubject-change-status'),
